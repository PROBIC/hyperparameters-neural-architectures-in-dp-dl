...
class MLPMultiLabel(torch.nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.groupnorm = torch.nn.GroupNorm(hidden_dim, hidden_dim)
    ...
    for epoch in range(dp_params.get("num_epochs")):
        with warnings.catch_warnings():
            ...
            for data, target in train_loader:
                ...
                #    model,
                #    epoch + 1,
                #    "/mimic3experiments/mlp_dp_gradients.csv",
                #)
                optimizer.step()
        ...
        write_stats(stats_dict, path=stats_path)
...
if __name__ == "__main__":
    ...
    train_with_params(
        ...
        stats_path="/mimic3experiments/gradient_count_test.csv",
    )
