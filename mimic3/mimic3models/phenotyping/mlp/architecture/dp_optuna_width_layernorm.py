...
def train_with_params(
    ...
    for epoch in range(dp_params.get("num_epochs")):
        ...
        stats_dict["title"] = "mimic3_phenotyping_mlp_dp_width_ln"
    ...
    def objective(trial):
        ...
        for seed in seeds:
            auc_dict, epsilon = train_with_params(
                ...
                stats_path="/mimic3experiments/mlp_optuna_architecture_width_layernorm_exp_{}_{}.csv".format(
...
if __name__ == "__main__":
    ...
    study = optuna.create_study(
        study_name="mlp_dp_width_layernorm_{}_{}".format(
    ...
    joblib.dump(
        study,
        str(
            "/mimic3experiments/mlp_dp_width_layernorm_{}_{}.pkl".format(
                str(sys.argv[1]), sys.argv[2]
            )
        ),
    )
