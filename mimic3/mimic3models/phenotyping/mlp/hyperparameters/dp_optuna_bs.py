    ...
    def objective(trial):
        ...
        for seed in seeds:
            auc_dict, epsilon = train_with_params(
                ...
                stats_path="/mimic3experiments/mlp_optuna_bs_new_exp_{}_{}.csv".format(
...
if __name__ == "__main__":
    ...
    study = optuna.create_study(
        study_name="mlp_dp_bs_new_{}_{}".format(str(sys.argv[1]), str(sys.argv[2])),
        direction="maximize",
    )
    ...
    joblib.dump(
        study,
        str(
            "/mimic3experiments/mlp_dp_bs_new_{}_{}.pkl".format(
                str(sys.argv[1]), sys.argv[2]
            )
        ),
    )
